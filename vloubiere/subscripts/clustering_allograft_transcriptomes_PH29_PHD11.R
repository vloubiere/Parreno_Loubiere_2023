...
dat <- readRDS("Rdata/RNA_tables_object.rds")$FC$allograft
...
obj[, cl:= hc]
saveRDS(obj,
        "Rdata/clustering_allograft_transcriptomes_PH29_PHD11.rds")

#------------------------------------------------#
# PLOT
#------------------------------------------------#
pdf("pdf/clustering/clustering_pre_implantation_allograft_transcriptomes_PHD11_PH29.pdf", width = 16)
