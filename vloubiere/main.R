...
if(F)
{
  ...
  #### Clustering ####
  file.edit("git_epiCancer/vloubiere/subscripts/clustering_transcriptomes.R") #OK
  ...
  file.edit("git_epiCancer/vloubiere/subscripts/Motif_enrichment_dose_transcriptomes.R") #OK
  file.edit("git_epiCancer/vloubiere/subscripts/Motif_lm_dose_transcriptomes.R") #OK
  file.edit("git_epiCancer/vloubiere/subscripts/features_dose_transcriptomes.R") #OK
  
  #### Comparison 18/29 DOSE ####
  file.edit("git_epiCancer/vloubiere/subscripts/diff_18_29_dose_clustering.R") #OK
  file.edit("git_epiCancer/vloubiere/subscripts/diff_18_29_motif_enrich_cl.R") #OK
  file.edit("git_epiCancer/vloubiere/subscripts/diff_18_29_apopstosis_heatmap.R") #OK
  file.edit("git_epiCancer/vloubiere/subscripts/diff_18_29_heatmap_top_diff_genes.R") #OK
  
  #### Clustering epiCancenr ####
  file.edit("git_epiCancer/vloubiere/subscripts/clustering_epiCancer_transcriptomes.R") #OK
  file.edit("git_epiCancer/vloubiere/subscripts/GO_epiCancer_transcriptomes.R") #OK
  file.edit("git_epiCancer/vloubiere/subscripts/STRING_epiCancer_transcriptomes.R") #OK
  file.edit("git_epiCancer/vloubiere/subscripts/Motif_enrichment_epiCancer_transcriptomes.R") #OK
